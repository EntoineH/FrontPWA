        ...
        <div>
            <div className="m-2 justify-center px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <img className="mx-auto h-44 w-auto rounded-xl" src="../OrganizeMe.png" alt="Your Company" />
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-sm">
                                    <a onClick={() => navigate('/resetpassword')} className="font-semibold text-indigo-600 hover:text-indigo-500">Forgot password ?</a>
                                </div>
                            </div>
                            <div className="mt-2">
                                <input
                    ...
                    <p className="mt-10 text-center text-sm text-gray-500">
                        Not a member ?
                        <a onClick={() => navigate('/register')} className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> Sign up</a>
                    </p>
                </div>
            </div>
